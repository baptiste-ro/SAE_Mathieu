...
<body>
    ...
    <div class="container-fluid position-relative p-0">
        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <% 
                    if (!connected) {
                        out.println("<a href='Vue/connexion.html.php' class='btn btn-primary rounded-pill py-2 px-4'>Se connecter</a>");
                    } else {
                        out.println("<a href='Vue/profil.php' class='btn btn-primary rounded-pill py-2 px-4'>Mon Profil</a>");
                    }
                %>
            </div>
        </nav>
        ...
        <div class="container-fluid bg-primary py-5 mb-5 hero-header background-image">
            <!-- Mise en forme !-->
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white mb-3 animated slideInDown">Bienvenue chez Mariteam</h1>
                        <p class="fs-4 text-white mb-4 animated slideInDown">Vos traversées en quelques clics </p>
                        <div class="position-relative w-75 mx-auto animated slideInDown">
                            <!-- Permet d'avoir une barre de recherche !-->
                            <input class="form-control border-0 rounded-pill w-100 py-3 ps-4 pe-5" type="text" placeholder="Ex: Locmaria">
                            <!-- Affiche le bouton "Rechercher" !-->
                            <button type="button" class="btn btn-primary rounded-pill py-2 px-4 position-absolute top-0 end-0 me-2" style="margin-top: 7px;">Recherche</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    ...
                    <div class="position-relative h-100">
                        ...
                        <img class="img-fluid position-absolute w-100 h-100 description_image" src="" alt="" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <h6 class="section-title bg-white text-start text-primary pe-3">A propos de nous</h6>
                    <h1 class="mb-4">Bienvenue chez <span class="text-primary">Mariteam</span></h1>
                    <!-- Permet de mettre du texte a coter de l'image -->
                    <p class="mb-4">Découvrez le plaisir de voyager sur les flots avec Mariteam, votre partenaire de confiance pour des traversées maritimes inoubliables. Explorez nos liaisons adaptées à vos besoins, consultez facilement nos horaires et nos tarifs compétitifs, et réservez votre place en quelques clics. </p>
                    <!-- Cette nouvelle ligne, permet de faire un nouveau paragraphe-->
                    <p class="mb-4">Avec Mariteam, profitez d'un service fiable et d'un confort optimal pour toutes vos traversées. Embarquez dès aujourd’hui pour une expérience maritime unique ! </p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="service-item rounded pt-3">
                        <div class="p-4">
                            ...
                            <p>Consultez les liaisons disponible pour voyager avec MarieTeam ! </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item rounded pt-3">
                        <div class="p-4">
                            ...
                            <p>Consultez les tarifs qui s'appliquent à vos profils, véhicules, et traversées ! </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item rounded pt-3">
                        <div class="p-4">
                            ...
                            <p>Consultez les horaires disponibles des liaisons, et choisissez-en un pour le réserver dès maintenant ! </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item rounded pt-3">
                        <div class="p-4">
                            ...
                            <p>Créez votre compte MarieTeam pour faciliter vos futurs traversées ! Connectez-vous et consultez votre profil pour retrouver vos données de voyage et accélerer vos réservations !</p>
                        </div>
                    </div>
                </div>
    ...
    <!-- permet de mettre la taille aux icones -->
    <div class="container-xxl py-5">
        <div class="container">
            <!-- Permet de placer le texte au milieu -->
            <div class="text-center pb-4 wow fadeInUp" data-wow-delay="0.1s">
                <!-- Met le texte en bleu-->
                <h6 class="section-title bg-white text-center text-primary px-3">Comment faire ?</h6>
                <!-- Met le texte en plus grand -->
                <h1 class="mb-5"> En 3 étapes et c'est fini !</h1>
            </div>
            <!-- Permet de mettre les images côte à côte -->
            <div class="row gy-5 gx-4 justify-content-center">
                <!-- Permet de choisir la taille -->
                <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.1s">
                    <!-- Permet de mettre les bordures-->
                    <div class="position-relative border border-primary pt-5 pb-4 px-4">
                        <!-- Permet de mettre le texte à l'interieur du cadre -->
                        <div class="d-inline-flex align-items-center justify-content-center bg-primary rounded-circle position-absolute top-0 start-50 translate-middle shadow" style="width: 100px; height: 100px;">
                            <!-- Permet de mettre le "1" dans le cercle -->
                            <i class="fa fa-globe fa-3x text-white">1</i>
                        </div>
                        <!-- Met le titre -->
                        <h5 class="mt-4">Choisi ta déstination</h5>
                        <!-- Permet de mettre les 2 barres bleu -->
                        <hr class="w-25 mx-auto bg-primary mb-1">
                        <hr class="w-50 mx-auto bg-primary mt-0">
                        <!-- Met le texte-->
                        <p class="mb-0">Choisi un port de départ et d'arrivée pour repérer le numéro de la liaison et le voyage de tes rêves n'attends plus que toi !</p>
                    </div>
                </div>
                <!-- Permet de choisir la taille-->
                <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="position-relative border border-primary pt-5 pb-4 px-4">
                        <!-- Permet de mettre le texte à l'interieur du cadre -->
                        <div class="d-inline-flex align-items-center justify-content-center bg-primary rounded-circle position-absolute top-0 start-50 translate-middle shadow" style="width: 100px; height: 100px;">
                            <!-- Permet de mettre le "2" dans le cercle -->
                            <i class="fa fa-dollar-sign fa-3x text-white">2</i>
                        </div>
                        <!-- met le titre -->
                        <h5 class="mt-4">Choisis la date et l'heure </h5>
                        <!-- Permet de mettre les 2 barres bleu -->
                        <hr class="w-25 mx-auto bg-primary mb-1">
                        <hr class="w-50 mx-auto bg-primary mt-0">
                        <!-- Met le texte-->
                        <p class="mb-0">Quand part-on, mon capitaine ? Sélectionne dans nos disponibilités le jour et l'heure de ton voyage !</p>
                    </div>
                </div>
                <!-- Permet de choisir la taille-->
                <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div class="position-relative border border-primary pt-5 pb-4 px-4">
                        <!-- Permet de mettre le texte à l'interieur du cadre -->
                        <div class="d-inline-flex align-items-center justify-content-center bg-primary rounded-circle position-absolute top-0 start-50 translate-middle shadow" style="width: 100px; height: 100px;">
                            <!-- Permet de mettre le "3" dans le cercle -->
                            <i class="fa fa-plane fa-3x text-white">3</i>
                        </div>
                        <!-- met le titre -->
                        <h5 class="mt-4">Réserve ! </h5>
                        <!-- Permet de mettre les 2 barres bleu -->
                        <hr class="w-25 mx-auto bg-primary mb-1">
                        <hr class="w-50 mx-auto bg-primary mt-0">
                        <!-- Met le texte-->
                        <p class="mb-0"> Tu as toutes tes données en tête ? Réserve directement depuis Horaires, après avoir selectionné l'horaire de ton choix pour le trajet de tes rêves ! </p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container py-5">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a href="Vue/connexion.html.php"> Se connecter</a> <br>

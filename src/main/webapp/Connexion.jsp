...
<head>
    ...
    <link href="css/connection/connection.css" rel="stylesheet">

    <script type="module" src="js/connexion/connexion.js" defer></script>
</head>
<body>
    ...
    <form method="POST" style="background-color: #B2CCCE; padding: 12px; border-radius: 4px;">
            ...
            <div style="display: flex; flex-direction: column; align-items: center;">
                <p class="hide" id="wrong_credential_box">Mauvais identifiant/mot de passe</p>
            </div>
            <br>
            <a href="CreateAccount.jsp" style="color: black;">Pas encore de compte ? Créer un compte</a>
        </form>
